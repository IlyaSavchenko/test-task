...
import { SpaceShipClass } from './spaceships/space-ship-class';
...
export class DataService {
  private spaceships: SpaceShipClass[] = [
    {id: 1,
    model: 'Prometeij',
    img: 'https://ytimg.googleusercontent.com/vi/faN5gEhnhHg/mqdefault.jpg',
    type: 'Пассажирский',
    typeimg: 'assets/img/icons/ferry.svg',
    price: '1 900 000$',
    prod_date: '02.09.2008',
    desc: 'Описание1',
    count_place: '500',
    size_team: '60',
    size_hold: '',
    ...
    {id: 3, model: 'MILLENNIUM FALCON',
    img: 'https://www.ilgincbilgiler.com.tr/wp-content/uploads/2017/10/artik-nerdeyse-gercek-hayatta-var-olan-star-wars-bilimi-360x180.jpg',
